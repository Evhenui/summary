...
const i18n = {
  en: {
    ...
    'proj1.desc': 'LMS platform — marketing site',
    'proj2.desc': 'Ongoing solo project — support, new features, UI',
    'proj3.desc': 'Corporate site rebrand, landing constructor & calculators',
    'proj4.desc': 'LMS platform - product app',
    'proj5.desc': 'Landing constructor',
    'proj6.desc': 'Support, new features',
  ...
  ua: {
    ...
    'proj1.desc': 'LMS-платформа — маркетинговий сайт',
    ...
    'proj4.desc': 'LMS-платформа — продуктовий додаток',
    'proj5.desc': 'Лендінг-конструктор',
    'proj6.desc': 'Підтримка, новий функціонал',
